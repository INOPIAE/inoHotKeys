...
'taken from https://stackoverflow.com/questions/2450373/set-global-hotkeys-using-c-sharp/27309185#27309185
Public NotInheritable Class ClsHooks
...
#End Region
    ...
    Public Sub RegisterHotKey(modifier As ModifierKeys, key As Keys)
        ...
        Debug.Print("modifier: " & modifier & " KeyAgreeRecipientInfo: " & key.ToString)
